...
var niftyCss = true; // whether CSS has been added or not
...
if (typeof(oldonload) == 'function') {
  window.onload = function() {
    oldonload();AddNiftyCornersCss();NiftyLoad()
  };
} else { 
  window.onload = function(){
    AddNiftyCornersCss(); NiftyLoad();
  };
}

function AddNiftyCornersCss(){
  niftyCss = true;
  var l = CreateEl("link");
...
function Nifty(selector,options){
  //alert('in start of Nifty: ' + selector + ', ' + options);
  if (niftyOk == false) {
    //alert('niftyOK is false');
    return;
  }  
  if (niftyCss==false) { 
    //alert('Adding CSS');
